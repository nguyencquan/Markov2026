...
\begin{align}
    E[A] &= \int_0^\infty E[Pois(2t/90)] 3e^{-3t} dt\\
    &= \frac 1{15}\int_0^\infty te^{-3t}dt\\
    &= \frac 1{15}(-\frac 13 te^{-3t}-\int_0^\infty -\frac 13e^{-3t}dt)\\
    &= \frac 1{15}(-\frac 13 te^{-3t} - \frac19e^{-3t}dt)|_0^\infty\\
    & = \frac{1}{135} = .0074
\end{align}
